...
namespace Project_IA.Controllers
{
    ...
    public class PostCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,ArticleTitle,ArticleType")] PostCategory postCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,ArticleTitle,ArticleType")] PostCategory postCategory)
        {
            if (ModelState.IsValid)
            {
